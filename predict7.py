...
model.add(GRU(128, return_sequences = True, input_shape=(sequence_len, vocab)))
model.add(Dropout(0.2))
model.add(GRU(64))
# model.add(Dropout(0.2))
...
history = model.fit(x, y, epochs = 2, validation_split = 0.05,  batch_size = 100, callbacks = callbacks_list, shuffle=True).history
